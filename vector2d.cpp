...
void Vector2D::setX(const float &value)
{
    x = value;
}
...
void Vector2D::setY(const float &value)
{
    y = value;
}
...
float Vector2D::cross2(const Vector2D &v1, const Vector2D &v2)
{
...
Vector3D Vector2D::barycentricCoordinates(const Vector2D &p1, const Vector2D &p2, const Vector2D &p3)
{
    ...
    float areal_123 = n.z; //n.length();//dobbelt areal
